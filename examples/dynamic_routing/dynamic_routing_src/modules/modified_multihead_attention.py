...
class ModifiedMultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.dynamic_routing_weights = [nn.Parameter(torch.Tensor( self.head_dim, self.num_heads, self.num_heads, device='cuda', dtype= torch.half)) for _ in range (0, self.num_heads)]
