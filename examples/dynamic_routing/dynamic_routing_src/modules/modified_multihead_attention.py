...
class ModifiedMultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.capsule_proj_weight = Parameter(torch.Tensor(512, 16))
        self.capsule_proj_bias = Parameter(torch.Tensor(512))  # emb_size
        #self.dynamic_routing_weight = nn.Parameter(torch.randn(1, 512, 128, 16, 128))
        self.dynamic_routing_weight = nn.Parameter(torch.Tensor(1, 512, 256, 16, 256))
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = ModifiedMultiheadAttention._append_prev_key_padding_mask(
