...
def multi_head_attention_forward(
    ...
    capsnet_sublayer = CapsuleSubLayer(num_routing=3, cuda_enabled=True, weights=dynamic_routing_weights, num_in = num_heads, num_out = num_heads, in_dim = head_dim, out_dim = head_dim)
